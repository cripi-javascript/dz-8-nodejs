...
*/
    var Event = function Event(data) {
        ...
        var eventDefaultVal = new Event(),
            newEvent = this;
        toExport.Model.call(this, eventDefaultVal);
        toExport.Model.call(this, data);
    ...
    Event.prototype = Object.create(toExport.Model.prototype, {
        constructor: {
            value: Event,
            enumerable: false,
            writable: true,
